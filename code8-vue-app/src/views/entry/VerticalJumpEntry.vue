...
<template>
  <div class="max-w-lg mx-auto">
    ...
    <div class="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
      <h1 class="text-2xl font-bold text-green-900">Vertical Jump</h1>
      <p class="text-sm text-green-700">Record max touch height. Vertical is auto-calculated from standing reach.</p>
    </div>
